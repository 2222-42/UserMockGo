...
func main() {
	...
	e.GET("/userModel/activate", userHandler.Activate)
	e.POST("/userModel/reissue", userHandler.Reissue)
	e.POST("/userModel/login", userHandler.Login)
	e.POST("/userModel/mfa", mfaHandler.MFAuthenticate)
